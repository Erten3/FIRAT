...
def main():
    ...
    connection = create_connection("localhost", "root", "Furkan12345", "firat_db")   
    # Tabloyu temizle
    ...
    while True:
        ...
        # Veri ekleme sorgusu
        insert_query = """
        INSERT INTO fw_uav (FW_UAV_time, FW_UAV_velocity, FW_UAV_altitude, FW_UAV_battery)
        VALUES (%s, %s, %s, %s)
        """
        data = (current_time, airspeed, altitude, battery)
